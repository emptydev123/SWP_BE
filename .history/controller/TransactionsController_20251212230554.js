 ...
 * 
 * Chức năng:
 * 1. Tạo payment link cho phí gia nhập CLB (MEMBERSHIP)
 * 2. Tạo payment link cho mua vé event (EVENT_TICKET)
 * 3. Xử lý webhook từ PayOS để cập nhật trạng thái transaction
 * 4. Xử lý return/cancel URL từ PayOS
 */

/**
 * Tạo payment link cho phí gia nhập CLB
 * - Khi sinh viên được duyệt tham gia CLB và cần đóng phí
 * - Tạo Transaction với type MEMBERSHIP
